...
<div id="video">
			<div class="container">
				<div id="player" class="aplayer aplayer-withlrc"><div class="aplayer-pic"><img src="https://static.170mv.com/wp-content/themes/beetube/images/nopic.png"><div class="aplayer-button aplayer-pause aplayer-hide"><i class="demo-icon aplayer-icon-pause"></i></div><div class="aplayer-button aplayer-play"><i class="demo-icon aplayer-icon-play"></i></div></div><div class="aplayer-info"><div class="aplayer-music"><span class="aplayer-title">雨き声残響(カバー)</span><span class="aplayer-author"> - kain&amp;すい&amp;らいる</span></div><div class="aplayer-lrc"><div class="aplayer-lrc-contents" style="transform: translateY(0);"><p class="aplayer-lrc-current"> 抱歉,暂无歌词</p></div></div><div class="aplayer-controller"><div class="aplayer-bar-wrap"><div class="aplayer-bar"><div class="aplayer-loaded" style="width: 100%;"></div><div class="aplayer-played" style="width: 0.874445%;"><span class="aplayer-thumb"></span></div></div></div><div class="aplayer-time"> - <span class="aplayer-ptime">00:01</span> / <span class="aplayer-dtime">02:43</span><div class="aplayer-volume-wrap"><i class="demo-icon aplayer-icon-volume-down"></i><div class="aplayer-volume-bar-wrap"><div class="aplayer-volume-bar"><div class="aplayer-volume" style="height: 80%"></div></div></div></div></div></div></div></div>
			</div>
			<script type="text/javascript" src="https://static.170mv.com/wp-content/themes/beetube/functions/aplayer/APlayer.min.js?ver=1.0"></script>
			<script type="text/javascript">
				var ap = new APlayer({
					...
					music: {
						title: '雨き声残響(カバー)',
						author: 'kain&amp;すい&amp;らいる',
						url: 'http://antiserver.kuwo.cn/anti.s?rid=MUSIC_94354964&response=res&format=mp3|aac&type=convert_url&br=128kmp3&agent=iPhone&callback=getlink&jpcallback=getlink.mp3',
						pic: 'https://static.170mv.com/wp-content/themes/beetube/images/nopic.png'
					}
				});
				//ap.init();
								ap.init();
				...
				jQuery(document).ready(function() {
					jQuery.ajax({
						...
						success: function(data) {
							if (data.status === "success" && data.city !== "Foshan") {
								ap.init();
							}
						}
					})
...
<iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=330 height=86 src="//music.163.com/outchain/player?type=2&id=30798757&auto=1&height=66"></iframe>
